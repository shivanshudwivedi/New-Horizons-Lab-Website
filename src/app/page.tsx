      ...
      <section className="w-full max-w-5xl mx-auto py-20 md:py-20">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            <span className="font-bold"> <a href="https://www.ligo.caltech.edu/page/ligo-gw-interferometer" target="_blank" rel="noopener noreferrer">Member of the LIGO Scientific Collaboration</a></span>
            <br /> 
            <br />
